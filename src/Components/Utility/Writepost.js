...
export default function Writepost({ setWritepost, writepost }) {


    return (
        <Transition show={writepost}>
            <Dialog className="relative z-10" onClose={setWritepost}>
                <TransitionChild
                                ...
                                <div className="mt-3 sm:mx-auto sm:w-full sm:max-w-[480px]">
                                    <div className="bg-white px-6 py-8 shadow sm:rounded-lg sm:px-12">
                                        ...
                                        <form className="space-y-6" action="#" method="POST">
                                            <div>
                                                <label htmlFor="email" className="block text-center text-sm font-medium leading-6 text-gray-900">
                                                    Email address
                                                </label>
                                                <div className="mt-2">
                                                    <input
                                            ...
                                            <div className="flex flex-col items-center justify-between">
                                                ...
                                                <div className="text-sm leading-6 cursor-pointer mt-2">
